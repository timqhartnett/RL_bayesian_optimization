...
random.seed(42)
WORKING_DIR = '/home/timothy/Bayesian_optimization/RL_bayesian_optimization'
...
with open("model_positive_expanded_state.json", "w") as json_file:
    json_file.write(target_json)
# serialize weights to HDF5
target_model.save_weights("target_model_positive_expanded_state.h5")
print("Saved model to disk")

# load json and create model
json_file = open('model_positive_expanded_state.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
model_3 = tf.keras.models.model_from_json(loaded_model_json)

model_3.load_weights("target_model_positive_expanded_state.h5")
